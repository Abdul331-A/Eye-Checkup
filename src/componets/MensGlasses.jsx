        ...
        <div className='p-20 px-44 capitalize'>
            <div>
                <div className='flex justify-between'>
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-primary  leading-tight pb-6">men's <br /> eyeglasses</h2>
                ...
                <div className='flex gap-9'>
                    <div className='flex'>
                        <div className='w-52 bg-[#D7E7E5]  text-center text-primary font-bold capitalize rounded-2xl shadow'>
                            <h3 className='py-14'>view all men's <br />collection</h3>
                            <img src={assets.mensEye} className='rounded-2xl' alt="" />
                        </div>
                    </div>

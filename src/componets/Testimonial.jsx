    ...
    return (
        <div className='px-4 sm:px-20 xl:px-32 py-24'>
            <div className='text-start'>
                <h2 className='text-primary text-[42px] font-semibold'>what our client say</h2>
                {/* <p className='text-gray-500 max-w-lg '>Don't just take our word for it. Here's what our users are saying.</p> */}
            </div>
            <div className='flex flex-wrap mt-10 justify-center'>
                {dummyTestimonialData.map((testimonial, index) => (
                    <div key={index} className='p-8 m-4 max-w-xs rounded-lg bg-[#FDFDFE] shadow-lg border border-gray-100 hover:-translate-y-1 transition duration-300 cursor-pointer'>
                        <h4 className='font-medium text-primary'>{testimonial.heading}</h4>
